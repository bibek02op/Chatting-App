...
public class Client implements ActionListener{
    ...
    Client(){
        ...
        ImageIcon i4 =new ImageIcon(ClassLoader.getSystemResource("icon/k.jpg"));
        Image i5 = i4.getImage().getScaledInstance(50, 50, Image.SCALE_DEFAULT);
        ImageIcon i6 = new ImageIcon(i5);
        JLabel profile= new JLabel(i6);
        profile.setBounds(70, 10, 50, 50);
        p1.add(profile);
        
        ImageIcon i7 =new ImageIcon(ClassLoader.getSystemResource("icon/videoo.png"));
        Image i8 = i7.getImage().getScaledInstance(30, 30, Image.SCALE_DEFAULT);
        ImageIcon i9= new ImageIcon(i8);
        JLabel videoo = new JLabel(i9);
        videoo.setBounds(300, 20, 30, 30);
        p1.add(videoo);
        ...
        p1.add(phone);
         ...
         ImageIcon i13 =new ImageIcon(ClassLoader.getSystemResource("icon/3dot.png"));
        ...
        JLabel name= new JLabel("beewake");
        name.setBounds(140,15,100,18);
        name.setForeground(Color.WHITE);
        name.setFont(new Font("SAN SERIF",Font.BOLD, 18));
        p1.add(name);
        
         JLabel status= new JLabel("ACTIVE NOW");
        status.setBounds(140,35,100,18);
        ...
        send.setBackground(new Color(7,91,81));
